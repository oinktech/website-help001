(function () {
    function initializeLoader() {
        const { imagePath, audioPath } = window.loaderConfig || {};

        if (!imagePath || !audioPath) {
            console.error('Image path and audio path must be provided');
            return;
        }
        ...
        loaderStyle.innerHTML = `
            :root {
                ...
                --logo-width: 150px; /* Adjust logo size */
            }
            ...
            .loading-overlay .loading-message::after {
        ...
        loaderOverlay.innerHTML = `
            ...
            <img src="${imagePath}" alt="Logo" class="loading-logo">
        ...
        function setAudio(src) {
            audio = new Audio(src);
            audio.loop = true;
            audio.onerror = () => console.warn('Error loading audio');
        }
        setAudio(audioPath);
    ...
    // Initialize the loader with configuration from window.loaderConfig
    initializeLoader();
})();
